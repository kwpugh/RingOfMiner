...
public class ItemRingMiner extends Item
{
	...
	public void addInformation(ItemStack stack, @Nullable World worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn)
	{
		...
		tooltip.add((new TranslationTextComponent("item.ring_of_miner.ring_of_miner.line1").applyTextStyle(TextFormatting.GREEN)));

		if(reverseRingMiner)
		{
			tooltip.add((new TranslationTextComponent("item.ring_of_miner.ring_of_miner.line5").applyTextStyle(TextFormatting.YELLOW)));
			tooltip.add((new TranslationTextComponent("item.ring_of_miner.ring_of_miner.line6").applyTextStyle(TextFormatting.YELLOW)));
		}
		else
		{
			tooltip.add((new TranslationTextComponent("item.ring_of_miner.ring_of_miner.line2").applyTextStyle(TextFormatting.YELLOW)));
			tooltip.add((new TranslationTextComponent("item.ring_of_miner.ring_of_miner.line3").applyTextStyle(TextFormatting.YELLOW)));
		}


		tooltip.add((new TranslationTextComponent("item.ring_of_miner.ring_of_miner.line4").applyTextStyle(TextFormatting.LIGHT_PURPLE)));
		tooltip.add((new TranslationTextComponent("item.ring_of_miner.ring_of_miner.cooldown",ringMinerCooldown).applyTextStyle(TextFormatting.LIGHT_PURPLE)));

		if(delayedBreakMode)
		{
			mode = "Delayed";
			tooltip.add((new TranslationTextComponent("item.ring_of_miner.ring_of_miner.mode", mode).applyTextStyle(TextFormatting.LIGHT_PURPLE)));
		}
		else
		{
			mode = "Instant";
